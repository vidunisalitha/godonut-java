 ...
 * @author dinis
 */
public class RequestLeaveFrame extends javax.swing.JFrame {

    /**
     * Creates new form RequestLeaveFrame
     */
    ...
    public RequestLeaveFrame(int frameNo, String empId, String name) {
        initComponents();
    ...
    public void loadRequests() {
        ...
        try {
            ...
            ResultSet rs = req.viewRequest("*", "user_id = ?", empID);
    ...
    public void hideIdColumn() {
        ...
        requestTable.getColumnModel().getColumn(3).setMinWidth(0);
        requestTable.getColumnModel().getColumn(3).setMaxWidth(0);
        requestTable.getColumnModel().getColumn(3).setWidth(0);
    ...
    private void initComponents() {
        ...
        leaveReasonTxtBox = new javax.swing.JTextArea();
        jLabel3 = new javax.swing.JLabel();
        makeReqBtn = new javax.swing.JButton();
        ...
        deleteReqBtn.setBackground(new java.awt.Color(255, 102, 102));
        deleteReqBtn.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        deleteReqBtn.setText("Delete");
        deleteReqBtn.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                deleteReqBtnMouseEntered(evt);
            }
            public void mouseExited(java.awt.event.MouseEvent evt) {
                deleteReqBtnMouseExited(evt);
            }
        });
        ...
        jLabel4.setText("Request Details");
        ...
        jPanel5Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(deleteReqBtn, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 462, Short.MAX_VALUE))
                .addContainerGap())
            .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(jPanel5Layout.createSequentialGroup()
                    .addContainerGap()
        ...
        jLabel5.setText("Make Your Leave Request");
        ...
        leaveReasonTxtBox.setColumns(20);
        leaveReasonTxtBox.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        leaveReasonTxtBox.setRows(5);
        jScrollPane1.setViewportView(leaveReasonTxtBox);

        jLabel3.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel3.setText("Describe your Request");

        makeReqBtn.setBackground(new java.awt.Color(102, 255, 102));
        makeReqBtn.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        makeReqBtn.setText("Make Request");
        makeReqBtn.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                makeReqBtnMouseEntered(evt);
            }
            public void mouseExited(java.awt.event.MouseEvent evt) {
                makeReqBtnMouseExited(evt);
            }
        });
        makeReqBtn.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                makeReqBtnActionPerformed(evt);
            }
        });
        ...
        jPanel6Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel6Layout.createSequentialGroup()
                ...
                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(makeReqBtn, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        jPanel6Layout.setVerticalGroup(
            ...
            .addGroup(jPanel6Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(makeReqBtn, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
        ...
        requestLeaveBtn.setBackground(new java.awt.Color(51, 204, 255));
    ...
    private void deleteReqBtnMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_deleteReqBtnMouseEntered
        deleteReqBtn.setBackground(new Color(255, 51, 51));
    }//GEN-LAST:event_deleteReqBtnMouseEntered

    private void deleteReqBtnMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_deleteReqBtnMouseExited
        deleteReqBtn.setBackground(new Color(255, 102, 102));
    }//GEN-LAST:event_deleteReqBtnMouseExited
    ...
    private void deleteReqBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteReqBtnActionPerformed
        ...
        if (requestTable.getSelectedRowCount() == 0) {
            ...
            JFrame f = new JFrame();
            if (JOptionPane.showConfirmDialog(f, "Do you want to delete this request?") == JOptionPane.YES_NO_OPTION) {
                Request req = new Request();
                req.setReqId(Integer.parseInt(df.getValueAt(requestTable.getSelectedRow(), 3).toString()));
                req.removeRequest();
                loadRequests();
            }
    ...
    private void makeReqBtnMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_makeReqBtnMouseEntered
        makeReqBtn.setBackground(new Color(0, 204, 102));
    }//GEN-LAST:event_makeReqBtnMouseEntered

    private void makeReqBtnMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_makeReqBtnMouseExited
        makeReqBtn.setBackground(new Color(102, 255, 102));
    }//GEN-LAST:event_makeReqBtnMouseExited
    ...
    private void makeComplaintBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_makeComplaintBtnActionPerformed
        this.dispose();
        new MakeComplainFrame(frameNo).setVisible(true);
    }//GEN-LAST:event_makeComplaintBtnActionPerformed

    private void makeReqBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_makeReqBtnActionPerformed
        if (leaveReasonTxtBox.getText().trim().equals("")) {
            JOptionPane.showMessageDialog(null, "Please Describe your Request");
            leaveReasonTxtBox.grabFocus();
        } else {

            DateTimeFormatter formatter = DateTimeFormatter.ofPattern("yyyy/MM/dd");

            Request req = new Request();
            req.setMDate(LocalDate.parse(dateLable.getText(), formatter));
            req.setDescription(leaveReasonTxtBox.getText());
            req.setStatus("Pending");
            req.makeRequest(uIDLable.getText());
            loadRequests();

        }
    }//GEN-LAST:event_makeReqBtnActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RequestLeaveFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RequestLeaveFrame(0, "", "").setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextArea leaveReasonTxtBox;
    private javax.swing.JButton logOutBtn;
    private javax.swing.JButton makeComplaintBtn;
    private javax.swing.JButton makeReqBtn;
