 ...
 * @author dinis
 */
public class SupervisorProfile extends javax.swing.JFrame {

    /**
     * Creates new form SupervisorProfile
     */
    static Point initialClick;

    public SupervisorProfile(String userid, String name) {
        initComponents();
    ...
    private void initComponents() {
        ...
        taskTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Task", "Employee Name", "Due Date", "Status"
            }
        ));
    ...
    private void updateProfileBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateProfileBtnActionPerformed
        this.dispose();
        new UpdateProfileFrame(5,uIDLable.getText(), uNameLable.getText()).setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SupervisorProfile.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SupervisorProfile("", "").setVisible(true);
            }
        });
    }
