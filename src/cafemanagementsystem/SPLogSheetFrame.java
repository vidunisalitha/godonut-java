 ...
 * @author dinis
 */
public class SPLogSheetFrame extends javax.swing.JFrame {

    /**
     * Creates new form SPLogSheetFrame
     */
    static Point initialClick;

    int lid = 0;

    public SPLogSheetFrame(String userID, String name) {
        initComponents();
    ...
    private void initComponents() {
        ...
        logTypeCmbBox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Front Terminal Log Sheet", "Employee Performance Log Sheet" }));
    ...
    private void assignTaskBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_assignTaskBtnActionPerformed
        this.dispose();
        new assignEmpTaskFrame(uIDLable.getText(), uNameLable.getText()).setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SPLogSheetFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SPLogSheetFrame("", "").setVisible(true);
            }
        });
    }
